...
/*CUE*/ int len, pos;
/*CUE*/ for (pos = 0; ; ) {
/*CUE*/ pos = (pos + 0x7FF) & -0x800;
/*CUE*/ fseek(infile, pos, SEEK_SET);
/*CUE*/ if (fread(&len, 1, 4, infile) != 4) break;
/*CUE*/ sprintf(nuevo, "%s-%06X", nombre, pos);
/*CUE*/ if ((outfile = fopen(nuevo, "wb")) == NULL) break;
/*CUE*/ pos += len;
